...
KeyboardControlState::KeyboardControlState(StateStack& stack, Context context)
	: State(stack, context)
	, mGUIContainer()
{
	...
	backButton->setCallback(std::bind(&KeyboardControlState::requestStackPop, this));

	mGUIContainer.pack(backButton);
}

void KeyboardControlState::draw()
{
...
bool KeyboardControlState::update(sf::Time)
{
	return true;
}

bool KeyboardControlState::handleEvent(const sf::Event& event)
{
...
void KeyboardControlState::updateLabels()
{
...
void KeyboardControlState::addButtonLabel(std::size_t index, std::size_t x, std::size_t y, const std::string& text, Context context)
{
